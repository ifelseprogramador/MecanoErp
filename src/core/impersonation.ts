/**
 * Modo suporte: o dono da plataforma "entra" numa oficina para agir em
 * nome dela (ver `core/admin/actions.ts#startImpersonation` e
 ...
 */
export const IMPERSONATION_COOKIE = "mecanoerp_impersonate_org";
