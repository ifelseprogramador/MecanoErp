...
const ACTION_LABELS: Record<string, string> = {
  "organizacao.criar": "Oficina criada",
  "organizacao.bloquear": "Oficina bloqueada",
  "organizacao.desbloquear": "Oficina desbloqueada",
  ...
  "live_support.chamar": "Oficina chamou o suporte",
  "live_support.aceitar": "Sessão de suporte aceita",
  "live_support.aprovar": "Oficina aprovou a sessão de suporte",
          ...
          <Dialog open={clearDialogOpen} onOpenChange={setClearDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Apaga todas as {entries.length} entradas do histórico desta oficina. Não afeta os
                  dados dela (clientes, veículos), só o registro de auditoria. Não tem volta.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
