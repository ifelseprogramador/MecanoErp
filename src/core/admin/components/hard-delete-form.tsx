      ...
      <DialogContent>
        <form action={formAction} className="flex flex-col gap-4">
          <DialogHeader>
            ...
            <DialogDescription>
              Remove a oficina, todos os clientes, veículos e acessos vinculados. Não tem volta.
              Digite o nome exato da oficina para confirmar.
            </DialogDescription>
          </DialogHeader>

          <div className="flex flex-col gap-2">
            <Label htmlFor="confirmName">Nome da oficina</Label>
