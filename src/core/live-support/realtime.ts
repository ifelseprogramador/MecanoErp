 ...
 * (a conexão do app inteiro já ignora RLS — ver docs/decisoes.md — então
 * Postgres Changes exigiria escrever policies novas só pra isso). Em vez
 * disso, cada canal é nomeado com um id de sessão (UUID, imprevisível) —
 * a "senha" do canal é o próprio id, do mesmo jeito que um link de
...
/** Canal por oficina — onde o widget do usuário escuta pedidos do admin. */
