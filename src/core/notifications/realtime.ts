 ...
 * filtrando pela oficina de quem está logado — o que chega pelo canal
 * nunca é a fonte da verdade.
 */

/** Notificações "pra todas as oficinas" (`organization_id` nulo). */
export function allNotificationsChannelName() {
  return "notifications:all";
}

/** Notificações só pra uma oficina. */
