 ...
 *
 * Ao vivo: escuta o canal "todas" e o da própria oficina (./realtime.ts).
 * Quando o dono envia/edita/apaga, relê a lista no servidor e mostra um
 * toast só das que ainda não estavam aqui — depois de alguns segundos o
 * toast some e a notificação fica só no sino, como não lida.
 */
